jQuery.fn.inputTip = function(options) {
    ...
    return this.each(function() {
        $(this).focus(function() {
            ...
            inputTipContainer.show().css("left", (thisOffset.left + thisRef.outerWidth() + 10) + "px").css("top", (thisOffset.top - 2) + "px");
...
jQuery.inputTipHelper.prototype = {
    ...
    SetTipContainerText: function(type, newForcedText) {
        ...
        switch (type) {
            ...
            case 3:
                {
                    this.TipContainer.addClass("emailInUse");
                    newText = this.Settings.emailInUse;
                }
                break;
             // bad word
            case 4:
                {
                  this.TipContainer.addClass("badInputTipContainer");
                  newText = this.Settings.invalidText;
                }
                break;
            case 5:
                {
                  this.TipContainer.addClass("badInputTipContainer");
                  newText = this.Settings.longText;
                }
                break;
        }
